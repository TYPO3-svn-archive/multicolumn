...
(function(jQuery) {
	...
	this.each(function() {
		...
		jQuery.fn.calculateSlidePos = function() {
			...
			jQuery(this).find('dt').not(':first').each(function(){	
				...
				if(u <= activeID){
					...
					if (slideOnFirstLoad == false) {
						jQuery(this).animate({'left': rightDtPos}, 0);
						jQuery(this).next().animate({'left':rightDdPos}, 0);
					}
					else {
		...
		var slideOnFirstLoad = settings.slideOnFirstLoad;
